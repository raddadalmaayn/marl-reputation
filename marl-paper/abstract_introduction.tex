...
$75.8\%$ in the training tail with a 48.0\% defense hold rate across
164{,}345 attack attempts.  An ablation study confirms that stake-based economic deterrence is the single most critical defense mechanism --- removing it degrades honest behavior below 90\% --- while parameter sensitivity analysis shows the system maintains $>95\%$ honest behavior for adversarial incentive bonuses up to $b=1.0$ (2$\times$ the baseline).  All source code, configurations, and training
