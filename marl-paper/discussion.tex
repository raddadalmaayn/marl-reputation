...
\textbf{Incomplete seeds:} C2 and C11 reported 4/5 seeds; the fifth seed
(seed 4) was still training at reporting time.  The high variance for C11
($\pm\!40.8\%$) means that the incomplete sample may not fully represent
